...
- Shows a per-model rain timeline above the map — accumulated rain the day before launch and that morning (ground-wetness signals, since a soaked field/access road can cancel a launch on an otherwise dry day) plus an hourly breakdown from 8am-4pm — with chance-of-rain and amount both available on hover.
