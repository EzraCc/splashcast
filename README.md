...
- Lets you narrow the apogee-altitude list to a min/max range (two dropdowns above the altitude legend) — useful once a tall-waiver site's list runs to 20+ options — on top of the existing per-altitude hover/pin isolation.
